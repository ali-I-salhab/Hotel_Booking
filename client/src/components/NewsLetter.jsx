  ...
  return (
    <div className="flex flex-col items-center max-w-5xl  lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
      <Title
        title={"Stay inspire"}
        subTilte={
          "    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Labore mollitia veniam laboriosam iste culpa et facilis obcaecati sunt, ullam eveniet voluptatem architecto accusamus neque rem! Rem, perspiciatis ab? Doloremque, doloribus!"
        }
      />
